...
CREATE TABLE `skladba` (
  ...
  `skladatel` varchar(20) COLLATE utf8_czech_ci DEFAULT NULL,
  ...
  KEY `FK_skl_zanr` (`id_zanr`),
  CONSTRAINT `FK_skl_zanr` FOREIGN KEY (`id_zanr`) REFERENCES `zanr` (`id_zanr`)
...
LOCK TABLES `skladba` WRITE;
/*!40000 ALTER TABLE `skladba` DISABLE KEYS */;
/*!40000 ALTER TABLE `skladba` ENABLE KEYS */;
UNLOCK TABLES;
